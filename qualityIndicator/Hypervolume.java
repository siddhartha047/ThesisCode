...
public class Hypervolume {
  ...
  */
  ...
  public double calculateHypervolume(double [][] front, int  noPoints,int  noObjectives){
      //System.out.println("calculateHypervolume");
    int     n;
  ...
  public double hypervolume(double [][] paretoFront, 
    ...
    normalizedFront = utils_.getNormalizedFront(paretoFront,
      ...
      System.out.println("pareto front:\n");
          ...
          for (int j = 0; j < paretoFront[i].length; j++) {
              System.out.println(i+":"+paretoFront[i][j]+"\t");
          }
          System.out.println();
      }
      */
    ...
    /*
      System.out.println("inverted frotn:");
      for (int i = 0; i < invertedFront.length; i++) {
          for (int j = 0; j < invertedFront[i].length; j++) {
              System.out.println(invertedFront[i][j]+"\t");
          }
          System.out.println();
      }
     */
